# ChatGPT 中文版：免费直连指南（支持GPT-4、GPT-4o、GPT-o1、DeepSeek，无需翻墙）【2025/06/28 更新】              
...
[**ChatGPT 中文版**](https://chat.lanjingai.org) 是 OpenAI 开发的 ChatGPT 模型的中文版本，为中文用户提供流畅而精准的AI对话体验。专门针对国内用户的使用习惯进行了以下优化：
